  ...
  <div class="w3-row">
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <button id="askQuestionBtn" type="button" class="w3-button w3-theme"><i class="fa fa-pencil"></i>     Ask Question</button> 
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w3-col m2">
      ...
      <ul>
        ...
        <li><a href="send_email.php">Email to admin</a></li>
...
askQuestionBtn.addEventListener('click', function() {
    ...
    window.location.href = 'pages/post_question.html.php';
  });
