...
<div class="w3-container w3-card w3-white w3-round w3-margin">
    <div class="container emp-profile">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                <form action="../../php_users/read/profile_user.php" method="post">
                                ...
                                <li class="nav-item">
                                <form action="../../php_users/read/activity.php" method="post">
                                    <input type="hidden" name="user_id" value="<?= $infors['user_id']; ?>">
            ...
            <div class="col-md-2">
                <form action="../../php_users/update/edit_profile.php" method="post">
                <?php if ($user_id_logging == $infors['user_id'] ) { ?>
                    <input type="hidden" name='user_id' value='<?= $infors['user_id']?> '>
                        <input type="submit" class="profile-edit-btn" value="Edit Profile"/>
                        <?php } ?>
                </form>
                <br>
                <form action="../../php_users/delete/delete_profile.php" method="post">
                <?php if ($user_id_logging == $infors['user_id'] ) { ?>
                    <input type="hidden" name='user_id' value='<?= $infors['user_id']?> '>
                ...
                <form action="../../php_users/update/change_password.php" method='post'>
                <?php if ($user_id_logging == $infors['user_id'] ) { ?>
                    <input type="hidden" name='user_id' value='<?= $infors['user_id']?>'>
