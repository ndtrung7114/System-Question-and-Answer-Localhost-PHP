    ...
    foreach ($question_order as $question): 
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin">
          ...
          <form action="search_module.php" method='post'>
            ...
            <h6> <input type="submit" name='search_from_question' style="background: none; border: none; padding: 0; font: inherit; cursor: pointer; text-decoration: none;" value="<?= $question['module_name'] ?>"> </h6>
          </form>
