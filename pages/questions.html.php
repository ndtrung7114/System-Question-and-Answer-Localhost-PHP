...
<?php
    ...
    if ($num_questions == 0) { ?>
      <div class="w3-container w3-card w3-white w3-round w3-margin">
        <h4>There are <?= $num_questions ?> result found.</h4>
      </div>
    <?php } else { ?>
    ...
    <?php foreach ($question_order as $question): 
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin">
          ...
          <form action="view_question.php" method="post">
            ...
            <h3><b><input type="submit" style="background: none; border: none; padding: 0; font: inherit; cursor: pointer; text-decoration: none;" value="<?= $question['title']; ?>"></b></h3> 
          ...
          <form action="search_module.php" method='post'>
            ...
            <h6> <input style="color:blue;" type="submit" name='search_from_question' style="background: none; border: none; padding: 0; font: inherit; cursor: pointer; text-decoration: none;" value="<?= $question['module_name'] ?>"> </h6>
          </form>
