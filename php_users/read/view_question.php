...
if ($result['notification_count'] > 0) {
   ...
   $sql_view = "SELECT question.question_id, question.user_id, question.module_id, question.vote, user.name, user.user_name, user.avatar, module.module_name, question.title, question.content, question.image, question.date, question.time
   FROM question
   ...
   include '../../pages_user/read/view_question.html.php';
   $output = ob_get_clean();
