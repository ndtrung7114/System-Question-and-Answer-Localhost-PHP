...
<div class="w3-container w3-card w3-white w3-round w3-margin">
  <h3>Users</h3>
    <div class="row mt-4">
        <form action="../../php_admin/read/search_user.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="search_user" id="search_php" placeholder="Filer by username..." aria-describedby="basic-addon2" autocomplete="off"> <br>
...
searchFunction("#search_php", "../read/complete_search_user.php");
</script>
