  ...
  <div class="w3-row">
      ...
      <div class="w3-card w3-round w3-white w3-hide-small">
        <div class="w3-container">
          ...
          <p>
            ...
            <span class="w3-tag w3-small w3-theme-d4">Greewich VietNam</span>
          ...
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <form action="search_question.php" method="post">
                <input type="text" class="w3-border w3-padding" name="search" placeholder="Type your question...">
                <button class="w3-button w3-orange" type="submit"><i class="fa fa-search"></i> Search</button>
              </form>
              <button id="askQuestionBtn" type="button" class="w3-button w3-orange"><i class="fa fa-pencil"></i>     Ask Question</button> 
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w3-col m2">
      ...
      <ul>
        ...
        <li><a href="">Team</a></li>
        <li><a href="save.php">Saves</a></li>
        <li><a href="module.php">Module</a></li>
        <li><a href="">Email from user</a></li>
        <li><a href="../pages/register.html.php">Sign Out</a></li>
      </ul>
...
askQuestionBtn.addEventListener('click', function() {
    ...
    window.location.href = '../pages_admin/post_question.html.php';
  });
