<div class="w3-container w3-card w3-white w3-round w3-margin">
  <?php if ($searchCountuser) { ?>
<h3><?= $searchCountuser?> Result</h3>
<?php } ?>
</div>
<?php
    session_start();
    ...
    foreach ($searchResults as $infor): 
        ...
        <div class="w3-container w3-card w3-white w3-round w3-margin">
            ...
            <form action="../../php_users/read/profile_user.php" method="post">
              ...
              <h4><input type="submit" style="background: none; border: none; padding: 0; font: inherit; cursor: pointer; text-decoration: none;" value="<?=$userData['user_name']?>"></h4>
