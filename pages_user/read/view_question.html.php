...
<div class="w3-container w3-card w3-white w3-round w3-margin">
            ...
            <div class="d-flex flex-row align-items-center"> <img src="../../images/<?= $question['avatar'] ?>" width="50" class="rounded-circle">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row icons d-flex align-items-center"> 
                        <form action="../../php_users/update/increase_vote.php" method='post'>
                    ...
                    <!-- Display alert if user tries to vote for themselves -->
                        ...
                        <span class="vote-count" row="10" height="10"> </span> <?= $question['vote'] ?>
                        <form action="../../php_users/update/decrease_vote.php" method='post'>
                                <input type="hidden" name='question_id' value=<?= $question['question_id']?>>
                                <input type="hidden" name='question_id_user' value=<?= $question['user_id']?>>
                                <input type="hidden" name='user_id_logging' value=<?= $user_id_logging ?>>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="questionDropdown">
                            <form action="../../php_users/create/save_question.php" method="post">
                            <input type="hidden" name="question_id" value="<?= $question['question_id']?>">
                            ...
                            <form action="../../php_users/delete/delete_question.php" method="post">
                                <input type="hidden" name="question_id" value="<?= $question['question_id']?>">
                            ...
                            <form action="../../php_users/update/edit_question.php" method="post">
                                <input type="hidden" name="question_id" value="<?= $question['question_id']?>">
    ...
    <?php foreach ($comments as $comment): ?>
        ...
        <div class="comment">
            ...
            <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row icons d-flex align-items-center">
            <form action="../../php_users/update/increase_vote_comment.php" method='post'>
            ...
            <span class="vote-count" row="10" height="10"></span>  <?= $comment['vote'] ?>
            <!-- Placeholder for displaying vote count -->
            <form action="../../php_users/update/decrease_vote_comment.php" method='post'>
                        <input type="hidden" name='comment_id' value=<?= $comment['comment_id']?>>
                        <input type="hidden" name='user_id_comment' value=<?= $comment['user_id']?>>
                        <input type="hidden" name='user_id_logging' value=<?= $user_id_logging ?>>
                        <button type="submit" name="minus" class="vote-btn" data-vote-type="up"><i class="fa-regular fa-thumbs-down"></i></button>
    ...
    // Check if the logged-in user is the owner of the comment
                ...
                <!-- Edit Button -->
                <form action="../../php_users/update/edit_comment.php" method="post">
                    <input type="hidden" name="comment_id" value="<?= $comment['comment_id'] ?>">
                    <input type="submit" style="border-radius: 10px;" class="w3-button w3-theme-d2 w3-margin-bottom" value="Edit">
                    
                </form>
    <!-- Delete Button -->
                <form action="../../php_users/delete/delete_comment.php" method="post">
                    <input type="hidden" name="comment_id" value="<?= $comment['comment_id'] ?>">
                    <input type="hidden" name="question_id" value="<?= $question['question_id'] ?>">
                ...
                <?php } ?>
                <form action="../../php_users/create/save_comment.php" method="post">
                            <input type="hidden" name="comment_id" value="<?= $comment['comment_id']?>">
                            <input type="hidden" name="user_id" value="<?= $user_id_logging?>">
    ...
    <!-- show comment reply -->
        ...
        <div class="dropdown-menu comment-rep-dropdown-menu dropdown-menu-right" aria-labelledby="commentRepDropdown<?= $comment_rep['comment_rep_id'] ?>">
            ...
            <!-- Edit Button -->
            <form action="../../php_users/update/edit_comment_rep.php" method="post">
    ...
    <div class="container mt-5">
        ...
        <form  action="../../php_users/create/post_comment_rep.php" method="post" enctype="multipart/form-data">
            <!-- Comment Content -->
...
<div class="container mt-5">
        ...
        <form  action="../../php_users/create/post_comment.php" method="post" enctype="multipart/form-data">
            <!-- Comment Content -->
            <div class="form-group">
