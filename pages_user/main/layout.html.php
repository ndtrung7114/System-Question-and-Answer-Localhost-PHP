...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <form action="../read/profile_user.php" method="post">
    <button type="submit" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="<?=$userDatalogging['user_name']?>">
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m2">
      ...
      <ul>
        ...
        <li><a href="../read/questions.php">Questions</a></li>
        <li><a href="../read/notify.php">Notification</a></li>
        <li><a href="../read/user.php">User</a></li>
        <li><a href="../read/save.php">Saves</a></li>
        <li><a href="../read/module.php">Modules</a></li>
        <li><a href="../create/send_email.php">Email to admin</a></li>
...
askQuestionBtn.addEventListener('click', function() {
    ...
    location = '/coursework/pages_user/create/post_question.html.php';
  });
